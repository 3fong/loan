...
<body>
	<form id="form1" name="form1" action="${SubmitURL}" method="post">
		<input id="WithdrawMoneymoremore" name="WithdrawMoneymoremore" value="${WithdrawMoneymoremore}" type="hidden" />
		...
		<input id="FeeQuota" name="FeeQuota" value="${FeeQuota}" type="hidden" />
